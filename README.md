...
项目简介：星际航行小游戏
这是我在高三时写的一款小型太空探索游戏。在游戏中，你可以驾驶火箭前往太阳、火星和月球等不同的天体。此外，游戏中还加入了一个“黑洞”设定，它可以将你随机传送到任何你想去的行星。

技术亮点与实现：
随机生成算法： 我利用随机生成技术模拟了火箭尾部的火焰喷射效果、火箭过于接近行星时的坠毁特效，以及太阳表面的太阳黑子。
动态星空背景： 背景中的“星星”是营造外太空氛围的关键元素。这些星星也是随机生成的，而且每当你按下控制键时，背景星空都会重新生成——这种视觉上的位移差让玩家感觉火箭正在浩瀚的太空中疾驰。
...
4. 操作方式： 使用键盘上的 上 (Up)、下 (Down)、左 (Left)、右 (Right) 方向键来控制火箭的飞行。探索整个地图

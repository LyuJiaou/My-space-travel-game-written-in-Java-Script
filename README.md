...
To run the game, download all the .java file into one folder and open the file called main.jave in vs-code (or any other editor, but I not sure they will work since I have only run them on vs-code. Then click run and debug to run the game.
